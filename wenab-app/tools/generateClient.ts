...
function loadOptions() {
  ...
  commander.option("-d --dotnet <dotnet>", "Dotnet Runtime", process.env.DOTNET_RUNTIME);
...
function runNswag(options: any) {
  ...
  const command = `${nswagPath} run ./config/${clientName}.nswag ${variables}`;
